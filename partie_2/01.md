...
À l’opposé du « mode texte », la numérisation en **mode image** repose sur la reproduction photographique ou le scan des documents, visant à restituer leur matérialité visuelle : texte, blancs, marges, typographie, ornements, tout est fixé dans une matrice de pixels. Cette approche, héritière des pratiques du microfilm et du fac-similé, s’impose dans les grandes politiques de numérisation patrimoniale dès les années 1990, avec des initiatives comme **Gallica** (BnF, 1997) ou **Google Books** (2004). Ces projets partagent l’ambition d’une mise à disposition massive du patrimoine imprimé, mais ils obéissent à des logiques divergentes : Gallica s’inscrit dans une mission de service public, valorisant la fidélité documentaire, la conservation et l’interopérabilité avec d’autres bibliothèques numériques (Bermès, *Trente ans de numérique à la BnF*, 2023) ; Google privilégie pour sa part la puissance de l’indexation et de la recherche plein texte, au détriment de l’intégrité des ouvrages comme objets.

Comme l’a souligné Emmanuelle Bermès dans *De l'écran à l'émotion* [Bermès], la numérisation ne se limite pas à la capture d’images mais constitue un processus technique et institutionnel engageant des choix de formats, de métadonnées et de modes d’accès. Numériser, c’est donc à la fois discrétiser l’information et l’intégrer dans un dispositif de diffusion -- PLAO, portails, bases de données, Web -- ce qui fait de la numérisation une forme de construction patrimoniale. Clavert insiste d’ailleurs sur cette dimension de « mise en données » (datafication) : transformer un artefact en données exploitables implique autant de décisions humaines que de contraintes techniques.

Le mode image, s’il conserve la matérialité visuelle du document, laisse souvent le chercheur face à des sources « muettes », difficiles à interroger sans traitements complémentaires (OCR, enrichissement, structuration). Comme le notait Bermès dès 2010 (*Numérisation à la demande*), ces corpus numériques sont comparables à des collections construites, produits de sélections et de médiations documentaires. Rygiel rappelle également que ces choix ne sont jamais neutres : les modalités de numérisation, d’indexation et de diffusion déterminent les usages possibles et introduisent des biais d’accès aux sources.

En ce sens, l’histoire des pratiques documentaires révèle une tension durable entre deux paradigmes : la transcription textuelle, qui sélectionne et structure, et la reproduction visuelle, qui fige l’objet. Mais dans le contexte institutionnel des grandes bibliothèques numériques, cette opposition s’inscrit dans un horizon plus large : celui de la datafication du patrimoine, où se mêlent enjeux techniques, politiques et sociaux de l’accès au savoir.
