...
### L'implémentation du schème opératoire transcriptif
...
3. Sortie structurée (API Mistral)
...
Un travail d'exploration technique a été fait. Une fois la tâche définie (éval de la sortie structurée). Prompts "natures". Schémas. Regex.
...
du problème de la vérité terrain, amender ses choix par rapport à la machine
